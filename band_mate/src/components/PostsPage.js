    ...
    <Box style={{ margin:"auto", height:"auto" }} bgcolor="#212121" color="#212121" p={2}>
            ...
            <Box bgcolor="#b9f6ca" color="#212121" p={2}>
              ...
              <Grid container wrap="nowrap" spacing={2}>
                ...
                <Grid item xs zeroMinWidth>
                  <h1 style={{ margin: 0, textAlign: "left" }}>{post.user_name}</h1>
                  <Chip style={{backgroundColor: "#dce775"}} label={`${post.post_type}`} />
                  <Chip style={{backgroundColor: "#dce775"}} label={`Genre: ${post.genre}`} />
                  <Chip style={{backgroundColor: "#dce775"}} label={`Instrument: ${post.instrument}`} />
                  ...
                  <Box display='flex' style={{justifyContent: "space-between", paddingRight: "20pt"}}>
                    ...
                    <p style={{ justifyContent: "left", color: "gray" }}>
                      posted {moment(post.created_on, "YYYYMMDD").fromNow()}
                    </p>
                    <p style={{ color: "gray" }}>
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          ...
          <h1 style={{ textAlign: "center" }}>This will be the comment section.</h1>
          <h2 style={{ textAlign: "center" }}>Component in the works!</h2>
