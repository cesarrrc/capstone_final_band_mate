...
function PostsPage(props) {
  ...
  return (
    <Box style={{ margin:"auto" }}bgcolor="#212121" color="#212121" p={2}>
      {props.posts.map((posts) => (
        <Paper p={2} style={{ maxWidth: '400pt', justifyContent: "center", margin:"20px auto 20px auto" }}>
                ...
                <Grid justifyContent="left" item xs zeroMinWidth>
                  ...
                  <Box display='flex' style={{justifyContent: "space-between", paddingRight: "20pt"}}>
                    ...
                    <p style={{ justifyContent: "left", color: "gray" }}>
                      posted {moment(posts.created_on, "YYYYMMDD").fromNow()}
                    </p>
                    <p style={{ color: "gray" }}>
                      {moment(posts.created_on).format('lll')}
                    </p>
