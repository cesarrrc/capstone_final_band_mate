...
import {  Avatar, Grid, Paper, Box } from "@material-ui/core";
            ...
            <Box bgcolor="#b9f6ca" color="#212121" p={2}>
              ...
              <Grid container wrap="nowrap" spacing={2}>
                ...
                <Grid item xs>
                  ...
                  <Chip style={{backgroundColor: "#dce775"}} label={`Email: ${user.email}`} />
                  <h3>Intruments:</h3>
                  {user.instruments.map((instrument,index) => (
                    <Chip key={index} style={{backgroundColor: "#dce775"}} label={`${instrument}`} />
                  ))}
                   <h3>Genre:</h3>
                  {user.genres.map((genre,index) => (
                    <Chip key={index} style={{backgroundColor: "#dce775"}} label={`${genre}`} />
                  ))}
                </Grid>
              </Grid>
            </Box>
